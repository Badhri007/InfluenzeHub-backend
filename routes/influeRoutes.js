...
const { getAllCampaigns,getParticularCampaign,getCampaignsCategoryWise,getAllPublicCampaigns} = require('../controllers/sponsor/getAllCampaignsController');
...
Router.get("/getAllPublicCampaigns",getAllPublicCampaigns)
